...
public class Interpreter {
    ...
    public static void main(String[] args) {
        ...
        IMyDict<String, IType> typeTable1 = new MyDict<>();

        try{
            ex1.typecheck(typeTable1); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IMyDict<String, IType> typeTable2 = new MyDict<>();

        try{
            ex2.typecheck(typeTable2); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IMyDict<String, IType> typeTable3 = new MyDict<>();

        try{
            ex3.typecheck(typeTable3); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IMyDict<String, IType> typeTable4 = new MyDict<>();

        try{
            ex4.typecheck(typeTable4); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IMyDict<String, IType> typeTable5 = new MyDict<>();

        try{
            ex5.typecheck(typeTable5); }
        catch (Exception e) {
            e.printStackTrace();
        }
        stk5.push(ex5);
        ...
        IMyDict<String, IType> typeTable6 = new MyDict<>();

        try{
            ex6.typecheck(typeTable6); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IMyDict<String, IType> typeTable7 = new MyDict<>();

        try{
            ex7.typecheck(typeTable7); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IMyDict<String, IType> typeTable8 = new MyDict<>();

        try{
            ex8.typecheck(typeTable8); }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        IStmt ex9 = new CompStmt(new DeclStmt("v", new IntType()),
                new CompStmt(new DeclStmt("a", new RefType(new IntType())),
                        new CompStmt( new AssignStmt("v", new ValueExp(new IntValue(20))),
                                new CompStmt(new New(new ValueExp(new IntValue(22)), "a"),  new ForkStmt(
        ...
        IMyDict<String, IType> typeTable9 = new MyDict<>();

        try{
            ex9.typecheck(typeTable9); }
        catch (Exception e) {
            e.printStackTrace();
        }
